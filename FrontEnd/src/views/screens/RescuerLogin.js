...
const RescuerLogin = ({ }) => {
    ...
    const loginHandle  = async () => {
        ...
        await axios({
            ...
            method: 'POST',
            url: "http://34.125.192.137:8080/Rescuer/login",
            data: userCreateBody,
        })
            .then(response => {
                setData({
            ...
            console.log(response.data)
                if ( response.data.responseCode==200) {
                    ...
                    AsyncStorage.setItem('rescuerLoginResponse', JSON.stringify(response.data))
                }
                else {
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            >
                ...
                <TouchableOpacity>
                    <Text style={{ color: '#7CB342', marginTop: 15 }}>Forgot password?</Text>
                </TouchableOpacity>
                            ...
                            <View style={{ backgroundColor: 'rgba(52, 52, 52, 0.0)', paddingVertical: 18, paddingHorizontal: 20, borderRadius: 23, }}>
                                <View style={{ backgroundColor: "#ffffff", paddingVertical: 30, borderTopColor: "black", paddingHorizontal: 30, borderRadius: 23, width: 340 }}>
                                    ...
                                    <View style={{ alignItems: 'center', alignContent: 'center', marginTop: 5, marginBottom: 30 }}>
                                        ...
                                        <Text style={{ fontSize: 14, color: '#4c4c4c' }}>You have successfully logged in!</Text>
                                ...
                                <View style={{ backgroundColor: "#ffffff", paddingVertical: 30, borderTopColor: "black", paddingHorizontal: 30, borderRadius: 23, width: 340 }}>
                                    ...
                                    <View style={{ alignItems: 'center', alignContent: 'center', marginTop: 5, marginBottom: 30 }}>
                                        {/* <Image
                                                        ...
                                                        source={require('../assets/warning.gif')}
                                                    /> */}
                                        <Text style={{ fontSize: 24, marginTop: 10, color: '#ed4337', fontWeight: 'bold' }}>Login Failed!</Text>
                                        <Text style={{ fontSize: 14, color: '#4c4c4c' }}>Incorrect username or password!</Text>
